...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-gray-100 pt-9 pb-9 pl-22 pr-22">
      <div className="bg-white rounded-2xl shadow-lg w-330 h-143 flex border-radius-2xl overflow-hidden">
