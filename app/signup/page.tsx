...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Step 1: Firebase me account banao
      ...
      if (!res.ok) {
        // Agar backend fail hua toh Firebase account bhi delete karo
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card {
          ...
          display: flex; width: 100%; max-width: 900px; overflow: hidden;
        }
        .left-panel {
        ...
        .left-panel img {
          width: 240px; height: 240px; object-fit: contain; position: relative;
          z-index: 1; filter: drop-shadow(0 8px 24px rgba(0,0,0,0.12));
        }
        .left-tagline {
          color: #ffffff; font-size: 18px; font-weight: 600; text-align: center;
          margin-top: 20px; line-height: 1.4; position: relative; z-index: 1;
        }
        .left-sub {
          color: rgba(255,255,255,0.85); font-size: 13px; text-align: center;
          margin-top: 8px; line-height: 1.5; position: relative; z-index: 1;
        }
        .right-panel {
          flex: 1; padding: 40px 44px 36px; display: flex;
          flex-direction: column; justify-content: center;
        }
        .brand { font-size: 26px; font-weight: 700; color: #064e3b; text-align: center; letter-spacing: -0.5px; margin-bottom: 6px; }
        .brand span { color: #10b981; }
        .subtitle { text-align: center; font-size: 13px; color: #6b7280; margin-bottom: 24px; }
        .field-label { display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 6px; }
        .input-field {
          width: 100%; padding: 11px 14px; border: 1.5px solid #d1d5db; border-radius: 10px;
          font-size: 14px; color: #111827; background: #f9fafb; outline: none; margin-bottom: 14px;
        ...
        .eye-btn {
          ...
          background: none; border: none; cursor: pointer; color: #6b7280; display: flex; align-items: center; padding: 4px;
        }
        ...
        .login-row { display: flex; justify-content: center; gap: 4px; font-size: 13px; color: #6b7280; margin-top: 16px; }
        .login-row span { color: #10b981; font-weight: 600; text-decoration: underline; cursor: pointer; }
      ...
      <div className="signup-page">
        <div className="card">
          <div className="left-panel">
            <Image src="/images/login.png" alt="Signup Illustration" width={240} height={240} />
            <p className="left-tagline">Join Canvasly Today!</p>
            <p className="left-sub">Create, collaborate, and bring<br />your ideas to life.</p>
          </div>
          ...
          <div className="right-panel">
            ...
            <form onSubmit={handleSignUp}>
              ...
              <button type="submit" className="submit-btn" disabled={loading}>
                {loading ? <><div className="spinner" /> Signing Up...</> : "Create Account"}
              </button>
            </form>
